...
# the following is copied from https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.2/install.sh after manual review
# the only change it to replace the body of nvm_reset() all the way at the bottom with : (indented on separate line between curly brackets):
