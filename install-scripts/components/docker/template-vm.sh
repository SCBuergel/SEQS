...
# this fingerprint:
#   * install source:  https://download.docker.com/linux/debian/gpg
#   * keyserver:        https://keyserver.ubuntu.com  (by fingerprint)
#   * keyserver:        https://keys.openpgp.org      (by fingerprint)
# It also matches download.docker.com/linux/ubuntu/gpg, and Wayback Machine
# snapshots of the install-source key from 2020 and 2023 are identical.
